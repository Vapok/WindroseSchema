...
namespace UECustom {
    ...
    // Calling GetValuePtrByPropertyNameInChain from UE4SS' own API for example would just return an empty object or null when WindroseSchema needs to call it.
