...
namespace Windrose {
	...
	public:
		...
		void Initialize();
	private:
        std::vector<std::unique_ptr<WindroseModLoaderBase>> m_loaders;
        ...
        // Makes WindroseSchema read paks from the 'WindroseSchema/mods' folder. Although the paks can be anywhere, prefer for them to be put inside 'YourModName/paks'.
        ...
        void RegisterLoader(std::unique_ptr<WindroseModLoaderBase> newLoader);
