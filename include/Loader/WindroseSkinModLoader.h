...
namespace Windrose {
	class WindroseSkinModLoader : public WindroseModLoaderBase {
	public:
		WindroseSkinModLoader();
	...
	private:
		...
		std::unordered_map<RC::StringType, RC::Unreal::UClass*> m_windroseSkinDataBaseClassCache;
